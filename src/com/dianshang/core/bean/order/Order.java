package com.dianshang.core.bean.order;
...
public class Order implements Serializable {
    ...
    /**
     * haha 支付方式 0:到付 1:在线 2:邮局 3:公司转帐
     */
    private Integer paymentWay;

    /**
     * haha 货到付款方式.1现金,2POS刷卡
     */
    ...
    /**
     * haha 支付状态 :0到付1待付款,2已付款,3待退款,4退款成功,5退款失败
     */
    private Integer isPaiy;

    /**
     * haha 订单状态 0:提交订单 1:仓库配货 2:商品出库 3:等待收货 4:完成 5待退货 6已退货
     */
